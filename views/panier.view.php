<div class="shop-baner">
    <div class="">
        <p class="text-bold text-5xl mb-4">Panier</p>
        <span class="px-3 font-sans ml-4"><a href="./home" class="text-gray-400 hover:text-primary">Home</a>
...
<div class="grid md:grid-cols-3 p-6 mt-16">
    <div class="panier col-span-2">
        ...
        <div class="md:flex justify-end">
            <button class="bg-primary md:w-auto w-[100%] mb-5 p-4 rounded-md mt-5 text-sm font-bold hover:bg-[#eeac00] hover:text-white">UPDATE PANIER</button>
        </div>
    </div>
    <div class="md:col-span-1 col-span-2 mb-20 mx-auto border-[5px] md:w-[90%] w-[100%] px-6 h-[390px]">
        ...
        <a href="">
            <button class="w-[100%]  bg-primary hover:bg-[#eeac00] hover:text-white p-3 rounded-md mt-[3rem] mb-8 text-sm font-bold">PROCEDER AU PAYEMENT</button>
        </a>
    </div>
</div>
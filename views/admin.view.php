...
<div class="col-sm-6 col-xl-3">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="mt-1 mb-3"><?= number_format($revenuCurrent, 0, ',', ' ')  ?> XAF</h4>
            <div class="mb-0">
...
<div class="col-sm-6 col-xl-3">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="mt-1 mb-3"><?= number_format($commandesCurrent, 0, ',', ' ')  ?></h4>
            <div class="mb-0">
...
<div class="col-sm-6 col-xl-3">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="mt-1 mb-3"><?= number_format($livrer, 0, ',', ' ')  ?></h4>
            <div class="mb-0">
...
<div class="col-sm-6 col-xl-3">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="mt-1 mb-3"><?= number_format($revenuTotal, 0, ',', ' ')  ?> XAF</h4>
            <div class="mb-0">
                <span class="badge badge-success-light"> <i class="mdi mdi-arrow-bottom-right"></i> 100% </span>

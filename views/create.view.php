...
<?php if (!$create) : ?>
    <div class="flex flex-col items-center justify-center h-[100%] mb-6">
        ...
        <div class="flex justify-between mt-4 w-[35%]">
            <a href="/" class="text-gray-500 font-sans border-dashed border-b-2 hover:text-primary">Créer plus tard</a>
            <a href="/compte.php" class="text-gray-500 font-sans border-dashed border-b-2 hover:text-primary">Se connecter</a>
        </div>
    </div>
<?php else : ?>
    <div class="flex flex-col justify-center items-center">
        <div class="alert-success"><?= read_flash_message() ?></div>
        <a href="/compte.php" class="w-[15%] mt-4"><button class=" bg-primary w-[100%] p-4 mt-3 mb-10  rounded-md hover:text-white font-bold">Se connecter</button></a>
    </div>

...
<div class="shop-baner">
    <p class="titre-baner">Shop</p>
    <span class="link-baner"><a href="/" class="text-gray-400 hover:text-primary">Home</a>
        <span class="font-bold text-xs text-gray-400"><i class="bi bi-chevron-right"></i></span> Shop</span>
</div>
<br>
...
<div class="md:flex md:justify-between">
    ...
    <div class="filter max-md:hidden">
        ...
        <form method="POST" class="mb-6">
            <div class="relative">
                <input type="search" id="default-search" class="block w-full p-5 pl-10 text-sm text-gray-600 border border-primary rounded-full outline-none" placeholder="Réchercher un produit..." required>

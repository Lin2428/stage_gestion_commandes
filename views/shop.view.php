...
<div class="md:flex md:justify-between">
                    ...
                    <a href="#">
                        <div class="card-head">
                            <div class="card-links">
                                ...
                                <a href="./?favorie=<?= $produit->getId() ?>"
                                    class="text-text-<?= $_SESSION['favorie'][$produit->getId()] ? "[#ff0000]" : "gray-400" ?> z-10  hover:text-black"><i
    ...
    <div class="filter max-md:hidden">
        <button class="masque-filter md:hidden font-sans text-gray-600 w-[100%] flex justify-end items-center"><span
                class="text-xs mr-2">MASQUER LE FILTRE </span><span class="text-black"><i
                    class="bi bi-x-lg"></i></span></span></button>
        <div class="filter-category-container">
            <p class="font-bold text-lg p-2">Catégories</p>
            <div class="filter-category">
                <?php foreach ($categories as $k => $categorie): ?>
                    <div class="categorie-link">
                        <a href="" class="flex items-center w-[100%] hover:text-primary text-sm font-sans text-gray-500">

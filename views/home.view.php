...
<div class="baner">
    ...
    <img src="<?= base_url('/assets/image/hamberger.png') ?>" alt="">
</div>
            ...
            <a href="#" class="category">
                ...
                <div class="flex flex-col items-center relative">
                    <img class="category-img"
                        src="<?= base_url('/assets/image/categories/' . $images[$k % count($images)]) ?>" alt="">
...
<section class="produit">
    <div class="produits-container grid grid-cols-4 gap-4 justify-center">
        <?php foreach ($produits as $produit): ?>
            <div class="card">
                <div class="card-head">
                    <div class="card-links">
                        <span class="statut">Sale!</span>
                        <a href="" class="text-gray-200"><i class="bi bi-heart-fill"></i></a>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="" class="bg-primary px-3 py-2 w-[2.5rem] rounded-2xl"><i class="bi bi-basket2-fill"></i></i></a>
                    </div>
                </div>
            </div>
        <?php endforeach ?>
